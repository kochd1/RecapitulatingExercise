...
h1{font-size: 40px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; margin-bottom: 65px;}

label{font-family: Arial, Helvetica Neue, Helvetica, sans-serif;}
...
<span class="inner-pre" style="font-size: 20px">
    ...
    <p><label for="Login" style= "font-size: 30px"><b>Login</b></label></p>
    <p><label for="Credentials"><strong>Please enter your credentials</strong></label></p>

    <p><label for="Username">Username:</label>
    <input type="text" name="user" class="form-control"></p>

    <p><label for="Password">Password:</label>
    <input type="password" name="pwd" class="form-control"></p>

    <p><input type="submit" value="Log in" class="btn-login btn-block"></p>
